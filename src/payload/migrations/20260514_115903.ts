...
export async function up({ db, payload: _payload, req: _req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum__header_v_published_locale" AS ENUM('en', 'sv');
  ...
  CREATE TYPE "public"."enum__footer_v_version_nav_items_link_type" AS ENUM('internal', 'external');
  CREATE TYPE "public"."enum__footer_v_version_status" AS ENUM('draft', 'published');
  CREATE TYPE "public"."enum__footer_v_published_locale" AS ENUM('en', 'sv');
  ...
  CREATE TABLE "header_locales" (
  	"site_tagline" varchar DEFAULT 'Boilerplate for Payload CMS and Next.js.',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" uuid NOT NULL
  );
  ...
  CREATE TABLE "_header_v_locales" (
  	"version_site_tagline" varchar DEFAULT 'Boilerplate for Payload CMS and Next.js.',
  	"id" serial PRIMARY KEY NOT NULL,
  	"_locale" "_locales" NOT NULL,
  	"_parent_id" uuid NOT NULL
  );
  ...
  CREATE TABLE "_footer_v_version_nav_items" (
  	...
  	"_parent_id" uuid NOT NULL,
  	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
  	"link_type" "enum__footer_v_version_nav_items_link_type" DEFAULT 'internal',
  	"link_url" varchar,
  	"link_label" varchar,
  	"link_new_tab" boolean,
  	"_uuid" varchar
